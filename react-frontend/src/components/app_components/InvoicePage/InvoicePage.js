...
const InvoicePage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("invoice")
            .find({ query: { $limit: 10000 , companyId : urlParams.singleCompaniesId ,item : urlParams.singleItemsId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="invoice-add-button"/>
                    
                    </>
                </div>
            </div>
            <div className="grid align-items-center">
                <div className="col-11" role="invoice-datatable">
...
/>            
      ...
      />
            ...
            <InvoiceCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
